...
function getVisualizedMesh( linearData, year, countries, exportCategories, importCategories ){
  ...
  uniforms = {
    ...
    texture:   { type: "t", value: 0, texture: THREE.ImageUtils.loadTexture( "res/images/particleA.png" ) },
  };
  ...
  var particleGraphic = THREE.ImageUtils.loadTexture("res/images/map_mask.png");
